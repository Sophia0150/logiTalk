...
class MainWindow(CTk):
    def init(self):
        ...
        self.menu_frame.pack_progarate(False)
    ...
    def toggle_show_menu(self):
        if self.is_show_menu:
            ...
            self.entry = CYkEntry(self.menu_frame)
            self.entry.pack()
        ...
        def show_menu(self):
            ...
            elif self.menu_frame.winfo_width() >= 40 and self.is_show_menu:
                self.after(10, self.show_menu)
        ...
        def add_message(self,text):
            self.chat_field.configure(text='normal')
...
def send_message(self):
    ...
    if message:
        self.add_message(f"{self.username}@[SYSTEM] {message}")
